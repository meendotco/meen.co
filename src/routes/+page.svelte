	...
	<div class="relative mx-auto size-full max-w-6xl px-4 py-20 md:px-12">
		...
		<div class="relative z-10 mt-32 w-full max-w-screen-lg px-4">
			<Container delay={0.1} customClass="mb-10">
				<div class="mx-auto flex max-w-2xl flex-col items-center text-center">
					...
					<p class="mt-6 text-center text-base text-accent-foreground/80 md:text-lg">
						Our intelligent platform helps you find the perfect solutions for your specific needs, whether you're handling inbound requests or conducting outbound searches
					</p>
				</div>
			</Container>
			...
			<div class="grid gap-6 md:grid-cols-2">
				<!-- Inbound Card -->
				<div class="group/feature relative overflow-hidden rounded-xl border border-border bg-card/30 p-8 backdrop-blur-md dark:border-white/10 dark:bg-black/30 cursor-pointer">
					<div class="from-neutral-80 pointer-events-none absolute inset-0 h-full w-full bg-gradient-to-t from-violet-950/25 to-transparent opacity-0 transition duration-200 group-hover/feature:opacity-100"></div>
					<div class="relative z-10 transform-gpu transition-all duration-300 group-hover/feature:-translate-y-1">
						<h3 class="mb-6 text-2xl font-semibold text-neutral-500 dark:text-white">For Inbound</h3>
